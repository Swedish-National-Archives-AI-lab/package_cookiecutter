...
def check_python_version() -> None:
    try:
        ...
        if version_match != REQUIRED_PYTHON_VERSION:
            ...
            print(
                "Please install the required Python version using pyenv and set it as global or local version."
            )
            sys.exit(1)
    except subprocess.CalledProcessError as e:
        print(
            "ERROR: Could not check Python version using pyenv. Ensure pyenv is installed and set up correctly."
        )
